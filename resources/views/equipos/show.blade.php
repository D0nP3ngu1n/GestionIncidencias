...
@section('contenido')
    ...
    <div id="caja-formulario">
        ...
        <div class="row">
    <h1 class="text-2xl font-bold mx-8 col-9">Equipo Nº {{ $equipo->etiqueta }}</h1>
    <div class="col-3  d-flex flex-column">
        <a id="botonCrear" href="{{ route('equipos.edit', $equipo) }}" class="w-100">
            ...
            <span class="ml-2">Editar Equipo</span>
        </a>
    </div>
</div>
