        ...
        <form action="{{ route('equipos.store') }}" method="POST" enctype="multipart/form-data" class="form-horizantal">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" id="etiqueta" name='etiqueta' placeholder="etiqueta" class="form-control">
                </div>
                <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="number" id="puesto" name='puesto' min="0" max="100" class="form-control">
                </div>
                <div class="col-sm-4">
